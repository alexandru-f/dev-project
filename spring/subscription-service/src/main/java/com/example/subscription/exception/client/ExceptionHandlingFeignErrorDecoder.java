...
import com.example.subscription.feign.HandleFeignError;
import feign.Feign;
...
public class ExceptionHandlingFeignErrorDecoder implements ErrorDecoder {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        for (Method m : clientMethods) {
            ...
            HandleFeignError annotation = getHandleFeignExceptionAnnotation(m);
            if (annotation != null) {
    ...
    private HandleFeignError getHandleFeignExceptionAnnotation(Method m) {
